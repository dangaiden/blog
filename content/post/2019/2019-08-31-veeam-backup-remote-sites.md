...
<span style="font-size: 16px; font-family: Nunito;"><img loading="lazy" class="alignnone wp-image-1035 size-medium_large" src="/wp-content/uploads/2019/08/VMware_proxy_default-768x545.png" alt="" width="656" height="466" srcset="/wp-content/uploads/2019/08/VMware_proxy_default-768x545.png 768w, /wp-content/uploads/2019/08/VMware_proxy_default-300x213.png 300w, /wp-content/uploads/2019/08/VMware_proxy_default-1024x727.png 1024w, /wp-content/uploads/2019/08/VMware_proxy_default.png 1125w" sizes="(max-width: 656px) 100vw, 656px" /></span>

<span style="font-size: 16px; font-family: Nunito;">Then, this window will appear, just enter the FQDN of your server:</span>

<span style="font-family: Nunito;"><img loading="lazy" class="alignnone wp-image-1029 size-medium_large" src="/wp-content/uploads/2019/08/NewWServer_1-768x545.png" alt="" width="656" height="466" srcset="/wp-content/uploads/2019/08/NewWServer_1-768x545.png 768w, /wp-content/uploads/2019/08/NewWServer_1-300x213.png 300w, /wp-content/uploads/2019/08/NewWServer_1-1024x726.png 1024w, /wp-content/uploads/2019/08/NewWServer_1.png 1128w" sizes="(max-width: 656px) 100vw, 656px" /></span>
...
<span style="font-family: Nunito;"><img loading="lazy" class="alignnone wp-image-1030 size-medium_large" src="/wp-content/uploads/2019/08/NewWServer_2_apply-768x551.png" alt="" width="656" height="471" srcset="/wp-content/uploads/2019/08/NewWServer_2_apply-768x551.png 768w, /wp-content/uploads/2019/08/NewWServer_2_apply-300x215.png 300w, /wp-content/uploads/2019/08/NewWServer_2_apply-1024x734.png 1024w, /wp-content/uploads/2019/08/NewWServer_2_apply.png 1124w" sizes="(max-width: 656px) 100vw, 656px" /></span>
...
<span style="font-family: Nunito;"><img loading="lazy" class="alignnone wp-image-1031 size-full" src="/wp-content/uploads/2019/08/Transport_mode.png" alt="" width="755" height="791" srcset="/wp-content/uploads/2019/08/Transport_mode.png 755w, /wp-content/uploads/2019/08/Transport_mode-286x300.png 286w" sizes="(max-width: 755px) 100vw, 755px" /></span>
...
<span style="font-size: 16px; font-family: Nunito;"><img loading="lazy" class="alignnone size-penscratch-featured wp-image-1028" src="/wp-content/uploads/2019/08/manual_datastores-656x300.png" alt="choose_manual_datastores" width="656" height="300" /></span>
...
<span style="font-family: Nunito;"><img loading="lazy" class="alignnone size-medium_large wp-image-1034" src="/wp-content/uploads/2019/08/VMware_proxy_summary-768x545.png" alt="" width="656" height="466" srcset="/wp-content/uploads/2019/08/VMware_proxy_summary-768x545.png 768w, /wp-content/uploads/2019/08/VMware_proxy_summary-300x213.png 300w, /wp-content/uploads/2019/08/VMware_proxy_summary-1024x727.png 1024w, /wp-content/uploads/2019/08/VMware_proxy_summary.png 1124w" sizes="(max-width: 656px) 100vw, 656px" /></span>
...
<span style="font-size: 16px; font-family: Nunito;"><img loading="lazy" class="alignnone size-medium wp-image-1050" src="/wp-content/uploads/2019/08/Backupjob_start-300x79.png" alt="" width="300" height="79" srcset="/wp-content/uploads/2019/08/Backupjob_start-300x79.png 300w, /wp-content/uploads/2019/08/Backupjob_start.png 464w" sizes="(max-width: 300px) 100vw, 300px" /></span>

<span style="font-family: Nunito;"><span style="font-size: 16px;">Now, step by step, pick a name for the job:</span><img loading="lazy" class="alignnone wp-image-1060 size-medium_large" src="/wp-content/uploads/2019/08/Backupjob_name-768x549.png" alt="" width="656" height="469" srcset="/wp-content/uploads/2019/08/Backupjob_name-768x549.png 768w, /wp-content/uploads/2019/08/Backupjob_name-300x214.png 300w, /wp-content/uploads/2019/08/Backupjob_name-1024x732.png 1024w, /wp-content/uploads/2019/08/Backupjob_name.png 1125w" sizes="(max-width: 656px) 100vw, 656px" /></span>

<span style="font-size: 16px; font-family: Nunito;">Proceed to select the VMs you want to backup (in our case the ones in the EUR site):</span><span style="font-family: Nunito;"><img loading="lazy" class="alignnone size-medium_large wp-image-1057" src="/wp-content/uploads/2019/08/Backupjob_vm_2-768x536.png" alt="" width="656" height="458" srcset="/wp-content/uploads/2019/08/Backupjob_vm_2-768x536.png 768w, /wp-content/uploads/2019/08/Backupjob_vm_2-300x209.png 300w, /wp-content/uploads/2019/08/Backupjob_vm_2-1024x715.png 1024w, /wp-content/uploads/2019/08/Backupjob_vm_2.png 1127w" sizes="(max-width: 656px) 100vw, 656px" /></span>

&nbsp;

<span style="font-size: 16px; font-family: Nunito;">Let&#8217;s continue and in the Backup proxy, click <strong>Choose&#8230;</strong> and select the correspondent backup proxy (EUR_proxy):<img loading="lazy" class="alignnone size-medium_large wp-image-1059" src="/wp-content/uploads/2019/08/Backupjob_proxy_3-768x547.png" alt="" width="656" height="467" srcset="/wp-content/uploads/2019/08/Backupjob_proxy_3-768x547.png 768w, /wp-content/uploads/2019/08/Backupjob_proxy_3-300x214.png 300w, /wp-content/uploads/2019/08/Backupjob_proxy_3-1024x729.png 1024w, /wp-content/uploads/2019/08/Backupjob_proxy_3.png 1128w" sizes="(max-width: 656px) 100vw, 656px" /></span>

&nbsp;

<span style="font-family: Nunito;"><span style="font-size: 16px;">Press OK and go to Advanced. Configure it like that if you want Synthetic  full backups:</span> <img loading="lazy" class="alignnone size-full wp-image-1055" src="/wp-content/uploads/2019/08/Backupjob_proxy_adv_4.png" alt="" width="726" height="837" srcset="/wp-content/uploads/2019/08/Backupjob_proxy_adv_4.png 726w, /wp-content/uploads/2019/08/Backupjob_proxy_adv_4-260x300.png 260w" sizes="(max-width: 726px) 100vw, 726px" /></span>
