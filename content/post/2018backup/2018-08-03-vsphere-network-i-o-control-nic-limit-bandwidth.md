...
<span style="font-family: Didact Gothic;"><span style="font-size: 12pt;">Enable the feature in the dvSwitch (in our case the one with Data Network):</span><span style="font-size: 10pt;"><img loading="lazy" class="alignnone size-full wp-image-163" src="/wp-content/uploads/2018/08/1st_dswitchenable.png" alt="" width="954" height="242" srcset="/wp-content/uploads/2018/08/1st_dswitchenable.png 954w, /wp-content/uploads/2018/08/1st_dswitchenable-300x76.png 300w, /wp-content/uploads/2018/08/1st_dswitchenable-768x195.png 768w" sizes="(max-width: 954px) 100vw, 954px" /></span><span style="font-size: 24px;"><strong>Scenario:</strong></span></span>

<span style="font-size: 12pt; font-family: Didact Gothic;">2 VMs within 2 Networks (Portgroups in dvSwitch)</span>

<span style="font-size: 10pt; font-family: Didact Gothic;"><img loading="lazy" class="alignnone size-full wp-image-175" src="/wp-content/uploads/2018/08/LogicalNW_NIOC.png" alt="" width="1314" height="676" srcset="/wp-content/uploads/2018/08/LogicalNW_NIOC.png 1314w, /wp-content/uploads/2018/08/LogicalNW_NIOC-300x154.png 300w, /wp-content/uploads/2018/08/LogicalNW_NIOC-1024x527.png 1024w, /wp-content/uploads/2018/08/LogicalNW_NIOC-768x395.png 768w" sizes="(max-width: 1314px) 100vw, 1314px" /></span>
...
<span style="font-size: 10pt; font-family: Didact Gothic;"><img loading="lazy" class="aligncenter wp-image-167" src="/wp-content/uploads/2018/08/5th_KenshiroVM.png" alt="" width="427" height="492" srcset="/wp-content/uploads/2018/08/5th_KenshiroVM.png 521w, /wp-content/uploads/2018/08/5th_KenshiroVM-261x300.png 261w" sizes="(max-width: 427px) 100vw, 427px" /></span>

<span style="font-size: 10pt; font-family: Didact Gothic;"><span style="font-size: 14px;"><span style="font-size: 16px;">If we launch iperf command with 200Mbps on port 9999 from KenshiroVM:</span></span><img loading="lazy" class="alignnone size-full wp-image-168" src="/wp-content/uploads/2018/08/6th_kenvm_iperf.png" alt="" width="710" height="123" srcset="/wp-content/uploads/2018/08/6th_kenvm_iperf.png 710w, /wp-content/uploads/2018/08/6th_kenvm_iperf-300x52.png 300w" sizes="(max-width: 710px) 100vw, 710px" /></span>

<span style="font-size: 10pt; font-family: Didact Gothic;"><span style="font-size: 16px;">We can see the traffic >on the destination</span> (<strong>Win10Pro</strong>) on the Data Network Adapter (you can see the subnet in the screenshot):</span><img loading="lazy" class="alignnone wp-image-169" src="/wp-content/uploads/2018/08/7th_win10proiperflimit.png" alt="" width="616" height="655" srcset="/wp-content/uploads/2018/08/7th_win10proiperflimit.png 699w, /wp-content/uploads/2018/08/7th_win10proiperflimit-282x300.png 282w" sizes="(max-width: 616px) 100vw, 616px" /></span>

<span style="font-size: 10pt; font-family: Didact Gothic;"><span style="font-size: 16px;">Also, we can review it in vSphere Web Client (25 MBps = 200 Mbps):</span><img loading="lazy" class="alignnone size-full wp-image-170" src="/wp-content/uploads/2018/08/8th_win10pro_monitor.png" alt="" width="888" height="558" srcset="/wp-content/uploads/2018/08/8th_win10pro_monitor.png 888w, /wp-content/uploads/2018/08/8th_win10pro_monitor-300x189.png 300w, /wp-content/uploads/2018/08/8th_win10pro_monitor-768x483.png 768w" sizes="(max-width: 888px) 100vw, 888px" /></span>

<span style="font-size: 10pt; font-family: Didact Gothic;"><span style="font-size: 12pt;"><strong>2.</strong> Now we are going to <strong>set a limit</strong> on KenshiroVM Data Network adapter to 88 Mbits:</span><img loading="lazy" class="wp-image-171 aligncenter" src="/wp-content/uploads/2018/08/9th_kenvm_limit.png" alt="" width="477" height="420" srcset="/wp-content/uploads/2018/08/9th_kenvm_limit.png 518w, /wp-content/uploads/2018/08/9th_kenvm_limit-300x264.png 300w" sizes="(max-width: 477px) 100vw, 477px" /></span>
...
<span style="font-size: 10pt; font-family: Didact Gothic;"><img loading="lazy" class="size-full wp-image-161 alignnone" src="/wp-content/uploads/2018/08/13rd_win10pro_nolimitnic.png" alt="" width="541" height="535" srcset="/wp-content/uploads/2018/08/13rd_win10pro_nolimitnic.png 664w, /wp-content/uploads/2018/08/13rd_win10pro_nolimitnic-300x297.png 300w" sizes="(max-width: 541px) 100vw, 541px" /></span>

<span style="font-size: 12pt; font-family: Didact Gothic;">KenshiroVM confirmed that it performed at 150 Mbps approximately:<img loading="lazy" class="alignnone size-full wp-image-162" src="/wp-content/uploads/2018/08/14th_kenvm_iperf_nolimit150mbps.png" alt="" width="709" height="164" srcset="/wp-content/uploads/2018/08/14th_kenvm_iperf_nolimit150mbps.png 709w, /wp-content/uploads/2018/08/14th_kenvm_iperf_nolimit150mbps-300x69.png 300w" sizes="(max-width: 709px) 100vw, 709px" /></span>
